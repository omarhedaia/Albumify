package com.example.useralbumviewer.util.screens
...
@Composable
fun UnAvailableInternetScreen(onTryAgainClicked:()->Unit){
        ...
        Box(
            ...
            Column(
                ...
                Image(
                    ...
                    contentDescription = stringResource(id = R.string.no_internet_image_desc),
